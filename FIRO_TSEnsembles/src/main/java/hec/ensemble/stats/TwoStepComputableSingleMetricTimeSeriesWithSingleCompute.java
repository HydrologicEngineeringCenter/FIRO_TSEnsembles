...
public class TwoStepComputableSingleMetricTimeSeriesWithSingleCompute implements SingleTimeSeriesComputable, Configurable {
    ...
    public TwoStepComputableSingleMetricTimeSeriesWithSingleCompute(Computable stepOne, ComputableIndex stepTwo) {
        _stepOne = stepOne;
        _stepTwo = stepTwo;
    ...
    public TwoStepComputableSingleMetricTimeSeriesWithSingleCompute(){ }

...
public class CrosshairMouseAdapter extends MouseAdapter {
    ...
    private void updateTooltip() {
        ...
        String pointResult = findNearestPointToDisplay(scl);
        if (pointResult != null) {
        ...
        String lineResult = findNearestLineToDisplay(scl, worldX, worldY);
        tooltipText = (lineResult != null) ? lineResult : String.format("y: %.2f", worldY);
    }

    private String findNearestPointToDisplay(Scale scl) {
    ...
    private String findNearestLineToDisplay(Scale scl, double worldX, double worldY) {

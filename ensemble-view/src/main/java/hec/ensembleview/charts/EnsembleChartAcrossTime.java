...
public class EnsembleChartAcrossTime extends EnsembleChart {
    ...
    public void highlightMembers(List<Integer> memberIndices) {
        ...
        // buildComponents tears down the panel and triggers a visible cascade of paints
        // as curves are re-added. Suppress the panel during the rebuild so the user sees
